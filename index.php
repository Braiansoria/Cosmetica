		...
		<div class="home">
			...
			<div class="home_slider_container">
				<div class="owl-carousel owl-theme home_slider">
					...
					<!-- Slide -->
					<div style="padding: 110px;" class="owl-item">
						<div class="background_image" style="background-image:url(assets/images/carrusel.jpg)"></div>
						<div class="container fill_height">
							<div class="row fill_height">
								<div class="col fill_height">
									<div class="home_container d-flex flex-column align-items-center justify-content-start">
										<div class="home_content">
											<div class="home_title">Nuevo</div>
											<div class="home_subtitle">En oferta</div>
												...
												<div class="row">
													...
													<div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
														<div class="product home_item_large">
															<div class="product_image"><img src="assets/images/carrusel.jpg" alt=""></div>
															<div class="product_content">																
																<div class="product_buttons">
																	<div class="text-right d-flex flex-row align-items-start justify-content-start">																		
																		<div class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
																			<div style="color: #ffff;">Ver mas</div>
																		</div>
																	</div>
																</div>
															</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 offset-lg-3">
						<div class="section_title text-center">Nuestros Productos</div>
					</div>
				</div>
				<div class="row products_row">
						...
						<div class="product">
							...
							<div class="product_content ">
								<div class="product_info d-flex flex-row align-items-start justify-content-center">
									<div>
										<div >
											<div class="product_name text-center"><a href="product.html">Shampoo solido arcilla blanca</a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col-xl-4 col-md-6">
						<div class="product">
							<div class="product_image"><img style="height: 390px;" src="assets/images/ACEITE DE COCO.jpg" alt=""></div>
							<div class="product_content ">
								<div class="product_info d-flex flex-row align-items-start justify-content-center">
									<div>
										<div >
											<div class="product_name text-center"><a href="product.html">Aceite de coco</a></div>
										</div>
									</div>
								</div>
				...
				<div class="row load_more_row">
					<div class="col">
						<div class="button load_more ml-auto mr-auto"><a href="productos.html">Ver Todos </a></div>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 feature_col">
						<div class="feature d-flex flex-row align-items-start justify-content-start">
							...
							<div class="feature_right d-flex flex-column align-items-start justify-content-center">
								<div class="feature_title">Envios a todo el pais</div>
							</div>
						</div>
					</div>
